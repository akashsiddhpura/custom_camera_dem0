...
import 'package:flutter_camera_demo/screens/image_gallery.dart';
import 'package:flutter_camera_demo/screens/video_player.dart';
                                      ...
                                      child: Slider(
                                        ...
                                        onChanged: (value) async {
                                          setState(() {
                                            ...
                                            //   FlashMode.off,
                                            // );
                                            if (dropdownEmploymentTypeValue ==
                                                3) {
                                              setState(() {
                                                _currentFlashMode =
                                                    FlashMode.torch;
                                      ...
                                      onTap: _isVideoCameraSelected
                                          ? () async {
                                              if (_isRecordingInProgress) {
                                                ...
                                                // _videoFile =
                                                //     await videoFile.copy(
                                                //   'storage/emulated/0/Pictures/$currentUnix.$fileFormat',
                                                // );
                                          ...
                                          : () async {
                                              ...
                                              } else if (dropdownEmploymentTypeValue ==
                                                  1) {
                                                setState(() {
                                                  _currentFlashMode =
                                                      FlashMode.auto;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        color: Colors.white,
        child: Center(
          child: Text("Please capture a video/picture first"),
        ),
      ),
    );
  }
